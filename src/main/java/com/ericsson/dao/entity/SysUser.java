 ...
 */
@Entity
@Table(name = "sys_user", schema = "public", uniqueConstraints = @UniqueConstraint(columnNames = "LOGIN_ID"))
public class SysUser implements java.io.Serializable {
	...
	public SysUser(Integer id, String loginId, String password, boolean isBuiltin,
	...
	public SysUser(Integer id, String loginId, String password, String name,
	...
	public SysUser(String loginId, String password, String name,
			String phone, String email, boolean isBuiltin, Date loginTime,
			Date passwordLastModifyTime, Date updateTime, Date createTime) {
		this.loginId = loginId;
		this.password = password;
	...
	@Id
	@SequenceGenerator(name="sys_user_id_seq",sequenceName="sys_user_id_seq",allocationSize=1)
